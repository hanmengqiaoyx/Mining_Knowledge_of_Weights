...
class Fully_Connect0(nn.Module):
    def __init__(self, in_features, out_features, bias=False):
        ...
        self.up_sample2 = Parameter(torch.Tensor(64, 32, 2, 2))
    ...
    def forward(self, input, epoch):
        if self.training:
            if epoch < 4:
                ...
                gate_prt = torch.zeros(self.in_features, 1).cuda()
                ...
                layer50 = F.relu(self.dw_bn5(nn.functional.conv2d(layer41, self.dw_weights5, stride=1, padding=1, bias=None)))  # [1, 256, 2, 1]
                ...
                layer100 = F.relu(self.up_bn40(nn.functional.conv_transpose2d(layer92, self.up_sample4, stride=(2, 1), bias=None)))
                ...
                layer_out = F.relu(self.bn0(nn.functional.conv2d(layer102, self.weights0, stride=1, padding=1, bias=None)))  # [1, 1, 64, 10]
